         ...
         <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center mx-auto">
                <div class="col-span-1 order-2 md:order-1">
                    <p id="acf-titel" class="text-15 leading-22 md:text-19 md:leading-27 xl:text-22 xl:leading-28 font-rubik text-white font-normal text-center mx-auto"><?php the_field('tekst');?></p>
                </div>
