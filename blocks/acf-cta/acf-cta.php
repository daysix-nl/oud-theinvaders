...
<section id="<?php the_field('blok_id');?>">
    <div class="container linkinnit">
        <div id="acf-titel" class="text-center mx-auto text-24 leading-32 md:text-31 md:leading-40 xl:text-36 xl:leading-50 font-space font-semibold text-white"><?php the_field('titel');?></div>
     </div>
