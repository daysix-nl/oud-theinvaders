...
<section id="<?php the_field('blok_id');?>">
    <div class="container">
        <p id="acf-tekst" class="text-16 leading-23 md:text-19 md:leading-27 xl:text-22 xl:leading-30 font-rubik text-white font-normal text-center mx-auto"><?php the_field('tekst');?></p>
    </div>
</section>