    ...
    <section>
        <div class="bg-[#0D0F1C]">
            <div class="container pt-7 md:pt-[70px] xl:pt-[100px] pb-8 md:pb-7 xl:pb-6">
                <h4
                    class="text-center text-white font-space font-semibold text-24 leading-32 md:text-31 md:leading-40 xl:text-36 xl:leading-50 max-w-[269px] md:max-w-[775px] xl:max-w-[775px] mx-auto">
                    <?php the_field('titel'); ?>
                </h4>
            </div>
            <div class="container grid grid-cols-2 md:grid-cols-5 gap-3 max-w-[325px] md:max-w-[765px] xl:max-w-[860px] work-list"
                id="<?php the_field('blok_id'); ?>">
                <?php
