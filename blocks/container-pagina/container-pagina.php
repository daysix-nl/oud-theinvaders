...
if (isset($block['data']['preview_image_help'])): /* rendering in inserter preview  */
    ...
    <main class="relative">
        ...
        <!-- BACKGROUND SETUP -->
        <img src="<?php the_field('afbeelding'); ?>" alt="background-<?php the_title(); ?>"
            class="absolute top-0 left-0 right-0 bottom-0 object-cover h-screen w-screen z-[-2] duration-[unset]">
        <div
            class="bg-gradient-to-b from-[#061116] via-[#01020385] to-[#061116] absolute top-0 left-0 right-0 bottom-0 object-cover h-screen w-screen z-[-1] duration-[unset]">
        </div>
        ...
        <div class="bg-gradient-to-b from-[<?php the_field('pagina_kleur'); ?>] to-[#0009] page-top duration-[unset]">
            <div class="container">
                <h1
                    class="text-40 leading-51 md:text-30 md:leading-39 xl:text-35 xl:leading-44 font-space text-white uppercase font-bold text-center mt-4 md:mt-7 xl:mt-8">
                    <?php the_title(); ?>
                </h1>
