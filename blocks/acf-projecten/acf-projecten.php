...
<section id="<?php the_field('blok_id');?>">
 <div class="container grid grid-cols-cols-1 md:grid-cols-3 gap-3 md:gap-2 px-1 xl:max-w-[880px] mx-auto work-block list-b-none h-auto">
            ...
            <?php if ($loop->have_posts()): ?>
                    <?php while ( $loop->have_posts() ) : $loop->the_post(); $id = get_the_ID(); ?>
                        ...
                        <a href="<?php the_permalink( $id ) ?>" class="col-span-1 flex flex-col h-auto card-work max-w-[330.2px] md:max-w-[unset] mx-auto">
                            ...
                            <div class="pt-1 pb-2 md:pb-[15px] px-2 md:px-[15px] bg-shape-purple h-full">
                                <h3 class="text-22 leading-20 md:text-17 md:leading-18 xl:text-19 xl:leading-18 font-space font-bold text-white md:mb-1 mb-1 "><?php the_field('teaser_title', $id);?></h3>
                                <p class="text-19 leading-20 md:text-17 md:leading-18 xl:text-18 xl:leading-19 font-space font-normal text-white"><?php the_field('teaser_subtitle', $id);?></p>
                            </div>
                        </a>
