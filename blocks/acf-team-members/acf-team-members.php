...
<section id="<?php the_field('blok_id');?>">
        ...
        <div class="container h-auto grid grid-cols-2 md:grid-cols-3 gap-x-[15px] gap-y-2 md:gap-x-2 md:gap-y-2 xl:gap-x-[25px] xl:gap-y-3 md:max-w-[750px] xl:max-w-[860px] mx-auto">
                ...
                while( have_rows('team_members_repeater') ) : the_row(); ?>
                    ...
                    <a href="<?php the_sub_field('linkedin');?>" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                        ...
                        <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                            <h3 class="text-14 leading-15 md:text-17 md:leading-16 xl:text-19 xl:leading-18 font-space font-bold text-white mb-[6px] md:mb-1 "><?php the_sub_field('naam');?></h3>
                            <p class="text-13 leading-14 md:text-15 md:leading-13 xl:text-16 xl:leading-16 font-space font-normal text-white"><?php the_sub_field('functie');?></p>
                            <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]"><?php the_sub_field('game');?></p>
                        </div>
                    </a>
