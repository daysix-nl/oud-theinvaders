...
<main class="relative ] ">
    ...
    <div class="bg-gradient-to-b from-[#48237F99] to-[#0009] page-top duration-[unset]">
        ...
        <!-- INTRO VERSION 1 -->
        <div class="container">
            <h1 class="text-40 leading-51 font-space text-white uppercase font-bold text-center mt-6 md:mt-12">Why</h1>
            <h2 class="text-20 leading-22 md:text-53 md:leading-55 font-rubik text-white font-semibold max-w-[298px] md:max-w-[765px] mx-auto text-center mt-5 md:mt-6">The world of gaming holds massive potential for brands.</h2>
            <p class="text-15 leading-22 md:text-25 md:leading-35 font-rubik text-white font-normal text-center mt-4 md:mt-6 max-w-[273px] md:max-w-full mx-auto">This marketing value can only be unlocked through a deep understanding of game culture and radically putting players first. That’s why you need a specialist.</p>
        </div>
        ...
        <div class="container mt-6 md:mt-12">
            <h3 class="text-18 leading-22 md:text-28 md:leading-40 font-rubik font-semibold text-white text-center max-w-[298px] md:max-w-[655px] mx-auto">That’s where we come in: we exist to do it right, <br>for gamers and for brands.</h3>
            <p class="text-15 leading-22 md:text-25 md:leading-35 font-rubik text-white font-normal text-center max-w-[311px] md:max-w-[721px] mx-auto mt-4 md:mt-6">We do so by understanding game culture, by connecting with players, pros and publishers around the globe. But most of all: by radically putting players first in every campaign we develop.</p>
        </div>
        ...
        <!-- XXX -->
        <div class="container mt-6 md:mt-8 pb-5 md:pb-[170px]">
            <h2 class="text-24 leading-32 md:text-40 md:leading-55 font-space font-semibold text-white text-center max-w-[269px] md:max-w-[903px] mx-auto">Wanna know how? <br><a href="mailto:info@theinvaders.nl" class="text-purplesoft hover:text-bluesoft">Press play</a> and start your new game.</h2>
        </div>
