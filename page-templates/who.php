...
<main class="relative">
    ...
    <!-- CONTENT AREA -->
    <div class="bg-gradient-to-b from-[#8E278A99] to-[#0009] page-top duration-[unset]">
  

        <!-- INTRO VERSION 1 -->
        <div class="container">
            <h1 class="text-40 leading-48 md:text-30 md:leading-36 xl:text-35 xl:leading-42 font-space text-white uppercase font-bold text-center mt-4 md:mt-7 xl:mt-8">Who</h1>
            <h2 class="text-22 leading-40 md:text-27 md:leading-28 xl:text-31 xl:leading-32 font-space text-white font-semibold mx-auto text-center mt-3 md:mt-3 xl:mt-4">Ready to meet our squad?</h2>
            <p class="text-15 leading-35 md:text-19 md:leading-27 xl:text-22 xl:leading-30 font-rubik text-white font-normal text-center mt-2 max-w-[300px] md:max-w-[360px] xl:max-w-[400px] mx-auto">Select your character &  get in touch!</p>
        </div>

        <!-- get in touch! -->
        <div class="container h-auto grid grid-cols-2 md:grid-cols-3 gap-x-[15px] gap-y-2 md:gap-x-2 md:gap-y-2 xl:gap-x-[25px] xl:gap-y-3 md:max-w-[750px] xl:max-w-[860px] mx-auto mt-4 pb-5 md:pb-9 xl:pb-[120px]">
           
            <a href="https://www.linkedin.com/in/ruben-houkes/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">The Godfather</p>
                </div>
            </a>

            <a href="https://www.linkedin.com/in/friedaulsamerdewaard/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Minecraft</p>
                </div>
            </a>

            <a href="https://www.linkedin.com/in/frankgoren/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">PS5 - It takes two</p>
                </div>
            </a>

             <a href="https://www.linkedin.com/in/kevin-loos-a5522628/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Fall Guys: Ultimate Knockout</p>
                </div>
            </a>

            <a href="https://www.linkedin.com/in/jeroen-van-lier-78210a7/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Super Mario</p>
                </div>
            </a>


            <a href="https://www.linkedin.com/in/pieter-doove-984595148/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Call of Duty</p>
                </div>
            </a>


             <a href="https://www.linkedin.com/in/janitaveenstra/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Minesweeper</p>
                </div>
            </a>


            <a href="https://www.linkedin.com/in/marie-claire-de-gou-6257307/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-13 leading-14 md:text-15 md:leading-13 xl:text-16 xl:leading-16 font-space font-normal text-white">Account director</p>
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Mario Kart</p>
                </div>
            </a>


            <a href="https://www.linkedin.com/in/lieke-hijmans-20090b33/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Let’s sing</p>
                </div>
            </a>


            <a href="https://www.linkedin.com/in/simone-brussel-094646116/" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">FIFA</p>
                </div>
            </a>


            <a href="nl.linkedin.com/pub/soo-jin-de-fraiture/2b/109/486" target="_blank" class="col-span-1 flex flex-col h-auto relative">
                <div class="absolute top-1 right-1 md:top-2 md:right-2 w-[17px] md:w-[24px] xl:w-[27px] h-auto aspect-square">
                    <?php include get_template_directory() . '/img/icons/linkedin.php'; ?>
                </div>
                ...
                <div class="pt-1 pl-1 pb-1 md:pb-2 bg-shape-purple h-full">
                    ...
                    <p class="text-white font-space font-normal text-10 leading-10 md:text-11 md:leading-11 xl:text-12 xl:leading-13 mt-0 md:mt-[15px]">Wii sports</p>
                </div>
            </a>
