...
function create_ptcase_post_type() {
    $labels = array(
        'name' => __('Case', 'textdomain'),
        ...
        'not_found' => __('No Case found', 'textdomain'),
        'not_found_in_trash' => __('No Case found in Trash', 'textdomain'),
    ...
    register_post_type('ptcase', $args);
}

add_action('init', 'create_ptcase_post_type');
